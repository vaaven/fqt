...
from FastQuantileTransformer.interpolate import interpolate_torch
from FastQuantileTransformer.utils import resample
...
class FastQuantileTransformer(QuantileTransformer):
    ...
    def _transform_col(self, X_col, quantiles, inverse):
        ...
        xp, _, device_ = get_namespace_and_device(X_col)
